...
| 序号 | 章节内容                                                        | 参考教材                                                      | 实验作业                               |
| :--: | --------------------------------------------------------------- | ----------------------------------------------------------- |---------------------------------- |
|  1   | [课程简介](人工智能与模式识别/Lec1%20绪论.pdf)               |  <font size="3">《机器学习》CH1-2 《模式识别》CH1</font>      |                                   |
|  2   | [线性模型](人工智能与模式识别/Lec2%20线性模型-HW1.pdf)             |  <font size="1">《机器学习》CH3   《模式识别》CH4</font>      | [HW1-线性模型实现餐厅利润和房屋价格预测](实验作业/实验作业一.pdf)  [data1](实验数据集/ex1-data1.txt) [data2](实验数据集/ex1-data2.txt)|
|  3   | [贝叶斯分类](人工智能与模式识别/Lec3%20贝叶斯分类-HW2.pdf)         |  <font size="1">《机器学习》CH7   《模式识别》CH2-3</font>    |  [HW2-基于贝叶斯分类器的性别分类](实验作业/实验作业二.pdf)  [traindata](实验数据集/ex2-traindata.csv) [testdata](实验数据集/ex2-testdata.csv)    |
